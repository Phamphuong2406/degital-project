...
namespace DigitalProject.Repositories.Interface
{
    public interface IProjectRepository
    {
        ...
        PagingModel<GetProject> GetListProjectByKey(string? key, string? structuralEngineer, DateTime? postingStartDate, DateTime? postingEndDate, int pageNumber, int pageSize);
